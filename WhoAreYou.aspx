<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WhoAreYou.aspx.cs" Inherits="WhoAreYou" %>
...
<head runat="server">
    ...
    <title>Who Are You - Get Started</title>
    <style>
        ...
        <div class="right-section">
            ...
            <div class="option-cards">
                <div class="option-card" id="citizenOption">
                    ...
                    <h3>Citizen</h3>
                    <a href="Login.aspx" class="btn-option">Continue</a>
                </div>
                <div class="option-card" id="providerOption">
                    <div class="option-icon">🏢</div>
                    <h3>Provider</h3>
                    <a href="ProviderLogin.aspx" class="btn-option">Continue</a>
                </div>
            </div>
        </div>
    </div>
